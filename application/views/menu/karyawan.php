      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            <a href="<?= base_url('karyawan/dashboard') ?>" class="nav-link <?= ($title == 'Dashboard') ? "active" : "" ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('karyawan/Kategori') ?>" class="nav-link <?= ($title == 'Kategori') ? "active" : "" ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('karyawan/Arsip') ?>" class="nav-link <?= ($title == 'Arsip') ? "active" : "" ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('karyawan/Pinjam') ?>" class="nav-link <?= ($title == 'Pinjaman') ? "active" : "" ?>">
