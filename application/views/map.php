        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9">
              <div class="card card-warning card-outline">
                <div class="card-header">
                  <h3 class="card-title text-primary">MAP : <?= $map->map ?> </h3>
                </div>
                <div class="card-body">
                  # Anda dapat mencari semua dokumen yang tersimpan dalam map ini.
                </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="card card-warning card-outline">
                <div class="card-body">
                  <img src="<?= base_url('')?>upload/qrcode/<?= $map->qrcode?>" class="img-fluid mb-3" alt="<?= $map->qrcode?>">
                  <h3 class="text-center"><?= $map->kode ?></h3>
                  <hr>
                  <a href="<?= base_url('Home/cetak_map/'.$map->id)?>" target="_blank" class="btn btn-warning btn-sm btn-block">Cetak</a>
                  <span>Anda dapat menempelkan QRCODE ini di cover map, untuk akses pencarian cepat.</span>
                </div>
              </div>
            </div>
          </div>
