        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9">
              <div class="card card-warning card-outline">
                <div class="card-header">
                  <h3 class="card-title text-primary">BOX : <?= $box->box ?> </h3>
                </div>
                <div class="card-body">
                  # Anda dapat mencari semua dokumen yang tersimpan dalam Box ini.
                </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="card card-warning card-outline">
                <div class="card-body">
                  <img src="<?= base_url('')?>upload/qrcode/<?= $box->qrcode?>" class="img-fluid mb-3" alt="<?= $box->qrcode?>">
                  <h3 class="text-center"><?= $box->kode ?></h3>
                  <hr>
                  <a href="<?= base_url('Home/cetak_box/'.$box->id)?>" target="_blank" class="btn btn-warning btn-sm btn-block">Cetak</a>
                  <span>Anda dapat menempelkan QRCODE ini di sisi Box, untuk akses pencarian cepat.</span>
                </div>
              </div>
            </div>
          </div>
