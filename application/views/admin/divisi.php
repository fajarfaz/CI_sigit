    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#tambah">
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <button class="btn btn-outline-warning btn-sm btn-edit" data-id="<?= $t->id ?>" data-divisi="<?= $t->divisi ?>" data-deskripsi="<?= $t->deskripsi ?>" data-status="<?= $t->status ?>"> <i class="fas fa-edit"></i></button>
                      <button class="btn btn-outline-danger btn-sm hapus" data-divisi="<?= $t->id ?>"> <i class="fas fa-trash"></i></button>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
    ...
    <div class="modal-content">
      <form action="Divisi/update" method="POST">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary">
            <li class="fas fa-save"></li> Update
          </button>
        </div>
      </form>
    </div>
    ...
    $('.hapus').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          location.href = "<?= base_url('admin/Divisi/hapus/') ?>" + id;
        }
      })
    });
    // get Edit Product
