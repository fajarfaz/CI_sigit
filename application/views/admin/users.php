                  ...
                  <tr>
                    ...
                    <td>
                      <div class="user-block">
                        <?php if ($t->foto == "") { ?>
                          <img class="img-circle img-bordered-sm" src="<?= base_url('upload/user/default.png') ?>" alt="<?= $t->nama_user ?>">
                        <?php } else { ?>
                          <img class="img-circle img-bordered-sm" src="<?= base_url('upload/user/' . $t->foto) ?>" alt="<?= $t->nama_user ?>">
                        <?php } ?>
                        <span class="username">
                          <a href="<?= base_url('admin/Users/detail/' . $t->id); ?>"><?= $t->nama_user ?></a>
                        </span>
                    ...
                    <td class="text-right">
                      <a href="<?= base_url('admin/Users/detail/' . $t->id); ?>" class="btn btn-outline-primary btn-sm "> <i class="fas fa-eye"></i></a>
    ...
    $('.hapus').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          location.href = "<?= base_url('admin/Users/hapus/') ?>" + id;
        }
      })
    });
