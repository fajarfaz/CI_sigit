          ...
          <div class="card-body">
            <div class="tab-content" id="custom-tabs-two-tabContent">
              <div class="tab-pane fade active show" id="ruang" role="tabpanel" aria-labelledby="ruang-tab">
                <button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#tambah-ruang">
                  <li class="fas fa-plus"></li> Tambah
                </button>
                <br>
                <hr>
              ...
              <div class="tab-pane fade" id="rak" role="tabpanel" aria-labelledby="rak-tab">
                <button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#tambah-rak">
                  <li class="fas fa-plus"></li> Tambah
                </button>
                <br>
                <hr>
              ...
              <div class="tab-pane fade " id="box" role="tabpanel" aria-labelledby="box-tab">
                <button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#tambah-box">
                  <li class="fas fa-plus"></li> Tambah
                </button>
                <br>
                <hr>
              ...
              <div class="tab-pane fade" id="map" role="tabpanel" aria-labelledby="map-tab">
                <button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#tambah-map">
                  <li class="fas fa-plus"></li> Tambah
                </button>
                <br>
                <hr>
  ...
  $(document).ready(function() {
    ...
    $('.hapus-ruang').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          location.href = "<?= base_url('admin/Sarana/hapus_ruang/') ?>" + id;
        }
      })
    });
    // button hapus rak
    $('.hapus-rak').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          location.href = "<?= base_url('admin/Sarana/hapus_rak/') ?>" + id;
        }
      })
    });
    // button hapus box
    $('.hapus-box').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          location.href = "<?= base_url('admin/Sarana/hapus_box/') ?>" + id;
        }
      })
    });
    // button hapus map
    $('.hapus-map').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          location.href = "<?= base_url('admin/Sarana/hapus_map/') ?>" + id;
        }
      })
    });
    // cek kode ruang
    $('#kode').change(function() {
      ...
      $.ajax({
        url: "<?php echo base_url('admin/Sarana/c_ruang') ?>",
        type: "POST",
        dataType: "JSON",
        data: {
          kode: kode
    ...
    $('#kode_rak').change(function() {
      ...
      // Kirim data ke controller MyTable dengan AJAX
      $.ajax({
        url: "<?php echo base_url('admin/Sarana/c_rak') ?>",
        type: "POST",
        dataType: "JSON",
        data: {
          kode: kode
    ...
    $('#kode_box').change(function() {
      ...
      // Kirim data ke controller MyTable dengan AJAX
      $.ajax({
        url: "<?php echo base_url('admin/Sarana/c_box') ?>",
        type: "POST",
        dataType: "JSON",
        data: {
          kode: kode
    ...
    $('#kode_map').change(function() {
      ...
      // Kirim data ke controller MyTable dengan AJAX
      $.ajax({
        url: "<?php echo base_url('admin/Sarana/c_map') ?>",
        type: "POST",
        dataType: "JSON",
        data: {
          kode: kode
