        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9">
              <div class="card card-warning card-outline">
                <div class="card-header">
                  <h3 class="card-title text-primary">RAK : <?= $rak->rak ?> </h3>
                </div>
                <div class="card-body">
                  # Anda dapat mencari semua dokumen yang tersimpan dalam Rak ini.
                </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="card card-warning card-outline">
                <div class="card-body">
                  <img src="<?= base_url('')?>upload/qrcode/<?= $rak->qrcode?>" class="img-fluid mb-3" alt="<?= $rak->qrcode?>">
                  <h3 class="text-center"><?= $rak->kode ?></h3>
                  <hr>
                  <a href="<?= base_url('Home/cetak_rak/'.$rak->id)?>" target="_blank" class="btn btn-warning btn-sm btn-block">Cetak</a>
                  <span>Anda dapat menempelkan QRCODE ini di sisi rak, untuk akses pencarian cepat.</span>
                </div>
              </div>
            </div>
          </div>
