...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <form action="<?= base_url('petugas/Arsip/add')?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                  <input type="file" name="arsip" class="form-control custom-file-input" id="customFile" accept=".jpg, .jpeg, .png, .gif, .doc, .docx, .xls, .xlsx, .csv, .ppt, .pptx, .pdf" required>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="ruang" id="" class="form-control" required>
            ...
            <div class="form-group">
              <label for="">Rak</label>
              <select name="rak" id="" class="form-control" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="">Box</label>
              <select name="box" id="" class="form-control" required>
            ...
            <div class="form-group">
              <label for="">Map</label>
              <select name="map" id="" class="form-control" required>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        location.href = "<?= base_url('petugas/Arsip/hapus/') ?>"+id;
      }
    })
  });
  // cek no dokumen
  $('#no_dokumen').change(function(){
      ...
      $.ajax({
        url: "<?php echo base_url('petugas/Arsip/cek_dokumen') ?>",
        type: "POST",
        dataType: "JSON",
